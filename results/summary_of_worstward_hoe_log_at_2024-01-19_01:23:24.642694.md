...
In the void, the head is the seat of all, and the head seems to be the only one that can go.
...
In the void there is a pipe in that void and a tube in that selfsame dim.
